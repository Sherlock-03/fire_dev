...
void DMA1_Channel4_IRQHandler(void)
{
  ...
  uart_dma_tx_isr(&cli_uart_ctrl.xUart);
...
void DMA1_Channel5_IRQHandler(void)
{
  ...
  uart_dma_rx_isr(&cli_uart_ctrl.xUart);
...
//    if (capture_time > charge_time && g_ir_stat == 0)
//    {
//        TRACE("capture_time : %d\n", capture_time);
...
//        g_ir_stat = 1;
//    }
//    else if (capture_time > charge_time && g_ir_stat == 1)
//    {
//        TRACE("capture_time : %d\n", capture_time);
