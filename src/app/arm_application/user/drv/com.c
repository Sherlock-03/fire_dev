...
{
    if (th_led_brightness != led_brightness)
    {
        th_led_brightness = led_brightness;
        data_save_direct();
    }
    ...
    led_cold_brightness = th_led_color_temperature * led_brightness / 1000;
    led_warm_brightness = (1000 - th_led_color_temperature) * led_brightness / 1000;
...
{
    if (th_led_color_temperature != led_color_temperature)
    {
        th_led_color_temperature = led_color_temperature;
        data_save_direct();
    }
    
    uint16_t led_cold_brightness = 0, led_warm_brightness = 0;
    /* You can't change the brightness when you adjust the color temperature */
    led_cold_brightness = led_color_temperature * th_led_brightness / 1000;
    led_warm_brightness = (1000 - led_color_temperature) * th_led_brightness / 1000;
