...
Flash_Err Spi_Flash_Erase(uint32_t addr, size_t size)
{
    ...
    {
        TRACE("Spi_Flash_Chip_Erase RUN\r\n");
        return Spi_Flash_Chip_Erase();
    }
        
    TRACE("Spi_Flash_Erase while run\r\n");
