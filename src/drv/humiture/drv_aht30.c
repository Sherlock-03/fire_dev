...
/*
    ...
    01b, 21May24, Jasper Add function aht30_read_humiture
*/
...
static void cli_humiture_get(cli_printf cliprintf, int argc, char **argv)
{
    int temperature = 0;
    uint16_t humidity = 0;
...
CLI_CMD_EXPORT(humiture_get, set night light status, cli_humiture_get)
